  ...
  return (
    <div className='fixed z-40 text-white left-[1rem] lg:left-[2rem] w-[2px] text-[14px] h-full flex flex-col justify-center '>
        <div className='relative  flex flex-col justify-center h-[40rem] w-[2px]'>
                ...
                <div className={`flex flex-col h-[120px] w-[1px]   ${firstColored==="black" ? "lg:bg-black lg:text-black" :"lg:bg-white lg:text-white" } ${firstColoredMobile==="black" ? "bg-black text-black" :"bg-white text-white" }   `} >
                <Link
            activeClass="active"
            to="Hero"
            spy={true}
