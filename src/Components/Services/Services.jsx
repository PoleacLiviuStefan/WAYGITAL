...
const Services = () => {
  return (
    <div name="Servicii" className='flex flex-col bg-transparent items-center justify-center text-white  w-screen h-full lg:mt-[20rem] lg:mb-[5rem] py-[5rem] lg:h-screen  '>
      <Fade>
