...
const PersonalCv = () => {
  ...
  const sitesLink = [
    ...
    "https://scoala-auto-moto-poptean.netlify.app/legislatie/chestionare-online",
    "https://4motoforrent.ro/",
    "https://lorenalash.ro/",
    "https://scoaladesoferi-diculescuciprian.ro/",
  ];
  ...
  return (
    <div className="relative h-full flex justify-center items-center bg-[#1A1A1A] font-montSerrat text-white">
      ...
      <div className="relative flex flex-col items-center w-full lg:w-[65rem] py-[15rem] ">
        ...
        <div className="relative mt-[4rem] flex flex-col items-center text-[20px] w-[1.2rem] h-[4rem] border-[1px] border-white rounded-[20px] py-[.2rem] opacity-[70%]">
          <span className="absolute top-[2.4rem] lg:animate-[mouseTouchDown_1.8s_linear_infinite]">
        ...
        >
          <div className="flex flex-col items-center lg:items-start w-[80%] lg:w-[30rem]">
            ...
            <p className=" text-gray-400 leading-5 text-justify lg:text-left">
              ...
              like a calculator, movie Finder (with faching data), then I was
