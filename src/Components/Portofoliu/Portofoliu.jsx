...
const Portofoliu = () => {
  ...
  return (
    <div name="Portofoliu" className='relative flex justify-center items-center w-full h-[25rem] lg:h-[55rem] bg-transparent'>
        <div className='flex flex-col items-center w-[80%] lg:w-[90%]'>
        <h2 className='absolute top-[2rem] text-[24px] lg:text-[56px]  font-extrabold font-outline-2    text-transparent'>PORTOFOLIU</h2>
