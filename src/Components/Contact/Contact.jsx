  ...
  return (
    <div className='relative flex justify-center items-center bg-[#1A1A1A] w-full h-[90rem] lg:h-[60rem]'>
        ...
        <div className='flex flex-col w-[18rem] lg:ml-[8rem] text-white  h-full lg:hidden'>
            ...
            <form onSubmit={e=>e.preventDefault} className='flex flex-col mr-[2rem] w-[18rem] mt-[3rem] lg:mt-0 lg:w-[30rem] h-[35rem] justify-between placeholder-gray-400 text-white'>
