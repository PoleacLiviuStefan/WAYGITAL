...
const Contact = () => {
  return (
    <div className='relative flex justify-center items-center bg-[#1A1A1A] w-full h-[90rem] lg:h-[60rem]'>
        <div className='relative flex lg:flex-row flex-col items-center lg:items-start justify-center w-[90%] '>
        <div className='flex flex-col lg:ml-[8rem] text-white  h-full lg:hidden'>
            ...
            <form onSubmit={e=>e.preventDefault} className='flex flex-col mr-[2rem] w-[30rem] h-[35rem] justify-between placeholder-gray-400 text-white'>
