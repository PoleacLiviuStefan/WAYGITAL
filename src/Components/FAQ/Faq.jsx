...
const Faq = () => {
  return (
    <div name="Intrebari Frecvente" className='relative flex flex-col items-center w-full h-full lg:h-screen  py-[10rem]  bg-transparent'>
  
              
              <div className='w-[80%] lg:w-full h-full py-[3rem] lg:py-[7rem] flex flex-col items-center lg:justify-center '>
              <Fade>
        <h2 className='relative text-[24px] lg:text-[56px] mb-[5rem] w-[80%] font-extrabold font-outline-1 lg:font-outline-2 text-center   '>INTREBARI <span className='text-white' > FRECVENTE</span></h2>
      </Fade>
                <Fade bottom>
