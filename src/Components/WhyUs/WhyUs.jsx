...
const WhyUs = ({transformBg}) => {
  return (
    <div name="Despre Noi" className={`relative text-white ${transformBg && "animate-[transformColor_1s_ease-in-out_forwards]"}  flex flex-col items-center justify-center  bg-[#1A1A1A] w-screen h-full mt-[10rem] lg:mt-[15rem] mb-[5rem]`}>
            ...
            <p className='relative mt-[1rem] w-[18rem] lg:w-[50rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est mollitia qui ea eligendi laborum dolorum illo eaque, quam, sint iste sit ut itaque hic quasi accusamus excepturi aut labore maiores esse enim nulla ad deleniti nobis! Ullam accusantium perferendis quia harum non, quam ipsam obcaecati corrupti quis officiis? Quisquam, excepturi!</p>
