...
const WhyUs = ({transformBg}) => {
  return (
    <div name="Despre Noi" className={`relative text-white ${transformBg && "animate-[transformColor_1s_ease-in-out_forwards]"}  flex flex-col items-center justify-center  bg-transparent w-screen h-full mt-[10rem] lg:mt-[15rem] mb-[5rem]`}>
            <h2 className=' text-[18px] lg:text-[38px] text-transparent font-outline-2 w-[18rem] lg:w-[50rem] font-bold' ><span className='text-white'>NOI NU </span> CREAM DOAR SITE-URI CONSTRUIM  <span className='text-white'> O CALE STABILA </span> PENTRU A ITI PROMOVA  <span className='text-white'>SERVIICILE / PRODUSELE </span> <img className='relative top-[-.4rem] lg:top-[-.8rem] lg:left-[16rem] w-[250px] lg:w-[500px]' src={underLIne} />  </h2>
